...
@section('title','Appliers')
@section('main')


<div class=" pt-8 my-4 py-6 mx-10/12">
    <h2 class=" sm:text-2xl sm:font-bold md:text-4xl md:font-extrabold mx-auto my-6 text-center text-cyan-700">All Postulants </h2>
    <hr class=" sm:w-24 md:w-48 h-1 mx-auto my-4 mb-10 bg-yellow-400 border-0 rounded md:my-7 dark:bg-gray-700">
  </div>
<div class="sm:w-full mt-16 md:container m-auto relative overflow-x-auto shadow-md sm:rounded-lg mb-6">
