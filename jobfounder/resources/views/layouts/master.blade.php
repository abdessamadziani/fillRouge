    ...
    <nav class="text-white bg-gradient-to-r from-cyan-700 to-blue-900 px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0  left-0  border-gray-200 dark:border-gray-600">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          {{-- <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"> --}}
            ...
            <li>
              <a href="#about" class="block duration-500 py-2 pl-3  md:hover:text-yellow-400 md:p-0   dark:hover:bg-yellow-400">About</a>
            </li>
            <li>
              <a href="#service" class="block duration-500 py-2 pl-3  md:hover:text-yellow-400 md:p-0   dark:hover:bg-yellow-400">Services</a>
            </li>
            <li>
              <a href="#contact" class="block duration-500 py-2 pl-3  md:hover:text-yellow-400 md:p-0   dark:hover:bg-yellow-400">Contact</a>
            </li>
            <li>
                <a href="#company" class="block duration-500 py-2 pl-3  md:hover:text-yellow-400 md:p-0   dark:hover:bg-yellow-400">Companies</a>
            </li>
            ...
            {{-- <li>
                <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register For Users</a>
            </li>
            <li>
     ...
     <footer class="bg-gradient-to-r from-cyan-700 to-blue-900 text-white">
        <div class="mx-auto w-full  container p-4 sm:p-6">
            <div class="md:flex md:justify-between">
              ...
              <div class="  grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      <h2 class="mb-6 text-md font-bold text-yellow-400 uppercase dark:text-white">Resources</h2>
                  ...
                  <div>
                      <h2 class="mb-6 text-md font-bold text-yellow-400 uppercase dark:text-white">Follow us</h2>
                  ...
                  <div>
                      <h2 class="mb-6 text-md font-bold text-yellow-400 uppercase dark:text-white">Legal</h2>
                      <ul class="text-white dark:text-gray-400 font-medium">
                          <li class="mb-4">
